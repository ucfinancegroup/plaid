...
/// struct for typed errors of method `retrieve_investments_holdings`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RetrieveInvestmentsHoldingsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `retrieve_investments_transactions`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RetrieveInvestmentsTransactionsError {
    UnknownValue(serde_json::Value),
}
...
pub async fn retrieve_investments_holdings(configuration: &configuration::Configuration, retrieve_investments_holdings_request: crate::models::RetrieveInvestmentsHoldingsRequest) -> Result<crate::models::RetrieveInvestmentsHoldingsResponse, Error<RetrieveInvestmentsHoldingsError>> {
    ...
    let local_var_uri_str = format!("{}/investments/holdings/get", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());

    if let Some(ref local_var_user_agent) = configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    local_var_req_builder = local_var_req_builder.json(&retrieve_investments_holdings_request);
...
pub async fn retrieve_investments_transactions(configuration: &configuration::Configuration, retrieve_investments_transactions_request: crate::models::RetrieveInvestmentsTransactionsRequest) -> Result<crate::models::RetrieveInvestmentsTransactionsRequest, Error<RetrieveInvestmentsTransactionsError>> {
    ...
    let local_var_uri_str = format!("{}/investments/transactions/get", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());

    if let Some(ref local_var_user_agent) = configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    local_var_req_builder = local_var_req_builder.json(&retrieve_investments_transactions_request);
