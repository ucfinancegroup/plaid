...
pub struct SimulateItemLoginRequiredSandboxOnlyRequest {
...
impl SimulateItemLoginRequiredSandboxOnlyRequest {
    pub fn new(client_id: String, secret: String, access_token: String) -> SimulateItemLoginRequiredSandboxOnlyRequest {
