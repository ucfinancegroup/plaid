...
pub struct RetrieveAuthEftResponse {
...
impl RetrieveAuthEftResponse {
    pub fn new(accounts: Vec<crate::models::Account>, item: crate::models::Item, numbers: crate::models::Numbers, request_id: String) -> RetrieveAuthEftResponse {
        RetrieveAuthEftResponse {
            accounts,
            item,
            numbers,
            request_id,
