...
pub struct CreateAssetReportExample {
...
impl CreateAssetReportExample {
    pub fn new(asset_report_id: String, asset_report_token: String, request_id: String) -> CreateAssetReportExample {
