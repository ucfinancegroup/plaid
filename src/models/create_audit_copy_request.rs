...
pub struct CreateAuditCopyRequest {
...
impl CreateAuditCopyRequest {
    pub fn new(client_id: String, secret: String, asset_report_token: String, auditor_id: String) -> CreateAuditCopyRequest {
