...
pub struct SearchInstitutionbyIdResponse {
...
impl SearchInstitutionbyIdResponse {
    pub fn new(institution: crate::models::Institution, request_id: String) -> SearchInstitutionbyIdResponse {
