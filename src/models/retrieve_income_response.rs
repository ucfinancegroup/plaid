...
pub struct RetrieveIncomeResponse {
    #[serde(rename = "income")]
    pub income: crate::models::Income,
    #[serde(rename = "request_id")]
    pub request_id: String,
}

impl RetrieveIncomeResponse {
    pub fn new(income: crate::models::Income, request_id: String) -> RetrieveIncomeResponse {
        RetrieveIncomeResponse {
            income,
            request_id,
        }
    }
