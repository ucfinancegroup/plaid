...
pub struct Item7 {
    ...
    pub accounts: Vec<crate::models::Account5>,
...
impl Item7 {
    pub fn new(accounts: Vec<crate::models::Account5>, date_last_updated: String, institution_id: String, institution_name: String, item_id: String) -> Item7 {
        Item7 {
            accounts,
            date_last_updated,
            institution_id,
