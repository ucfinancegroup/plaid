...
pub struct UpdateAnItemsWebhookRequest {
...
impl UpdateAnItemsWebhookRequest {
    pub fn new(client_id: String, secret: String, access_token: String, webhook: String) -> UpdateAnItemsWebhookRequest {
