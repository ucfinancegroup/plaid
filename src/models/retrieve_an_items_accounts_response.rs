...
pub struct RetrieveAnItemsAccountsResponse {
...
impl RetrieveAnItemsAccountsResponse {
    pub fn new(accounts: Vec<crate::models::Account>, item: crate::models::Item, request_id: String) -> RetrieveAnItemsAccountsResponse {
