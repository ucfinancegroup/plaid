...
pub struct SearchInstitutionbyNameResponse {
...
impl SearchInstitutionbyNameResponse {
    pub fn new(institutions: Vec<crate::models::Institution>, request_id: String) -> SearchInstitutionbyNameResponse {
