...
pub struct SearchInstitutionbyNameExample {
...
impl SearchInstitutionbyNameExample {
    pub fn new(institutions: Vec<crate::models::Institution>, request_id: String) -> SearchInstitutionbyNameExample {
