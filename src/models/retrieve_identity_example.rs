...
pub struct RetrieveIdentityExample {
...
impl RetrieveIdentityExample {
    pub fn new(accounts: Vec<crate::models::Account>, identity: crate::models::Identity, item: crate::models::Item, request_id: String) -> RetrieveIdentityExample {
        RetrieveIdentityExample {
            accounts,
            identity,
            item,
            request_id,
