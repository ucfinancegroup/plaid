...
pub struct CreateItemCustomSandboxOnlyRequest {
    ...
    pub options: crate::models::Options1,
}

impl CreateItemCustomSandboxOnlyRequest {
    pub fn new(client_id: String, secret: String, institution_id: String, initial_products: Vec<String>, options: crate::models::Options1) -> CreateItemCustomSandboxOnlyRequest {
        CreateItemCustomSandboxOnlyRequest {
            client_id,
            secret,
            institution_id,
            initial_products,
