...
impl CreateLinkTokenRequest {
    pub fn new(client_id: String, secret: String, client_name: String, country_codes: Vec<String>, language: String, user: crate::models::User, products: Vec<String>) -> CreateLinkTokenRequest {
