...
impl Payment {
    pub fn new(payment_id: String, amount: crate::models::PaymentAmount, status: crate::models::PaymentStatus, recipient_id: String, reference: String, last_status_update: String) -> Payment {
        Payment {
            payment_id,
            amount,
            status,
