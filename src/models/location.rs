...
impl Location {
    pub fn new(address: Option<String>, city: Option<String>, lat: Option<String>, lon: Option<String>, state: Option<String>, store_number: Option<String>, zip: Option<String>) -> Location {
        Location {
            address,
            city,
            lat,
