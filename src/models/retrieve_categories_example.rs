...
pub struct RetrieveCategoriesExample {
...
impl RetrieveCategoriesExample {
    pub fn new(categories: Vec<crate::models::Category>, request_id: String) -> RetrieveCategoriesExample {
