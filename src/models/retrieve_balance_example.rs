...
pub struct RetrieveBalanceExample {
...
impl RetrieveBalanceExample {
    pub fn new(accounts: Vec<crate::models::Account>, item: crate::models::Item, request_id: String) -> RetrieveBalanceExample {
