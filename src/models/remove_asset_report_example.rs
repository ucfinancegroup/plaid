...
pub struct RemoveAssetReportExample {
...
impl RemoveAssetReportExample {
    pub fn new(removed: bool, request_id: String) -> RemoveAssetReportExample {
        RemoveAssetReportExample {
            removed,
            request_id,
        }
    }
