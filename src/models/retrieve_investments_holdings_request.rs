...
pub struct RetrieveInvestmentsHoldingsRequest {
...
impl RetrieveInvestmentsHoldingsRequest {
    pub fn new(client_id: String, secret: String, access_token: String) -> RetrieveInvestmentsHoldingsRequest {
