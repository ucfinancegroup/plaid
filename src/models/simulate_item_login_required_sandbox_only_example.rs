...
pub struct SimulateItemLoginRequiredSandboxOnlyExample {
...
impl SimulateItemLoginRequiredSandboxOnlyExample {
    pub fn new(request_id: String, reset_login: bool) -> SimulateItemLoginRequiredSandboxOnlyExample {
