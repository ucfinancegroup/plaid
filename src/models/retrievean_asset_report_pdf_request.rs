...
pub struct RetrieveanAssetReportPdfRequest {
...
impl RetrieveanAssetReportPdfRequest {
    pub fn new(client_id: String, secret: String, asset_report_token: String) -> RetrieveanAssetReportPdfRequest {
