...
pub struct CreateAssetReportRequest {
...
impl CreateAssetReportRequest {
    pub fn new(client_id: String, secret: String, access_tokens: Vec<String>, days_requested: i32, options: crate::models::Options2) -> CreateAssetReportRequest {
