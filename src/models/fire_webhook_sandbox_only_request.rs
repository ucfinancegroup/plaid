...
pub struct FireWebhookSandboxOnlyRequest {
...
impl FireWebhookSandboxOnlyRequest {
    pub fn new(client_id: String, secret: String, access_token: String, webhook_code: String) -> FireWebhookSandboxOnlyRequest {
        FireWebhookSandboxOnlyRequest {
            client_id,
            secret,
            access_token,
            webhook_code,
