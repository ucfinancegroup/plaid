...
impl Transaction {
    pub fn new(account_id: String, account_owner: Option<String>, amount: f32, category: Vec<String>, category_id: String, date: String, iso_currency_code: String, location: crate::models::Location, name: String, payment_meta: crate::models::PaymentMeta, pending: bool, pending_transaction_id: Option<String>, transaction_id: String, transaction_type: String, unofficial_currency_code: Option<String>) -> Transaction {
        Transaction {
            account_id,
            account_owner,
            amount,
