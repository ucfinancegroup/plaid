...
pub struct CreateLiabilitiesReportExample {
...
impl CreateLiabilitiesReportExample {
    pub fn new(liabilities_report_id: String, liabilities_report_token: String, request_id: String) -> CreateLiabilitiesReportExample {
        CreateLiabilitiesReportExample {
