...
pub struct RetrieveLiabilitiesReportResponse {
    #[serde(rename = "report")]
...
impl RetrieveLiabilitiesReportResponse {
    pub fn new(report: crate::models::Report1, request_id: String, warnings: Option<String>) -> RetrieveLiabilitiesReportResponse {
