...
pub struct RetrieveLiabilitiesResponse {
...
impl RetrieveLiabilitiesResponse {
    pub fn new(accounts: crate::models::RetrieveAnItemsAccountsResponse, item: crate::models::RetrieveItemResponse, liabilities: serde_json::Value, request_id: String) -> RetrieveLiabilitiesResponse {
        RetrieveLiabilitiesResponse {
            accounts,
            item,
            liabilities,
            request_id,
