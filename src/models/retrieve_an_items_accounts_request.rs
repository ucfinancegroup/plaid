...
pub struct RetrieveAnItemsAccountsRequest {
...
impl RetrieveAnItemsAccountsRequest {
    pub fn new(client_id: String, secret: String, access_token: String) -> RetrieveAnItemsAccountsRequest {
