...
pub struct CreateLinkTokenPaymentInitiationRequest {
    ...
    pub payment_initiation: crate::models::PaymentInitiation,
}

impl CreateLinkTokenPaymentInitiationRequest {
    pub fn new(client_id: String, secret: String, client_name: String, country_codes: Vec<String>, language: String, user: crate::models::User, products: Vec<String>, payment_initiation: crate::models::PaymentInitiation) -> CreateLinkTokenPaymentInitiationRequest {
        CreateLinkTokenPaymentInitiationRequest {
            client_id,
            secret,
            client_name,
            country_codes,
