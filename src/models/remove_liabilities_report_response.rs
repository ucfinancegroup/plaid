...
pub struct RemoveLiabilitiesReportResponse {
...
impl RemoveLiabilitiesReportResponse {
    pub fn new(removed: bool, request_id: String) -> RemoveLiabilitiesReportResponse {
