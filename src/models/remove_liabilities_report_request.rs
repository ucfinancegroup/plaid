...
pub struct RemoveLiabilitiesReportRequest {
...
impl RemoveLiabilitiesReportRequest {
    pub fn new(client_id: String, secret: String, liabilities_report_token: String) -> RemoveLiabilitiesReportRequest {
        RemoveLiabilitiesReportRequest {
            client_id,
            secret,
