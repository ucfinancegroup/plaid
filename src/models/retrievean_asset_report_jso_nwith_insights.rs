...
pub struct RetrieveanAssetReportJsoNwithInsights {
    #[serde(rename = "report")]
...
impl RetrieveanAssetReportJsoNwithInsights {
    pub fn new(report: crate::models::Report, request_id: String, warnings: Vec<String>) -> RetrieveanAssetReportJsoNwithInsights {
        RetrieveanAssetReportJsoNwithInsights {
            report,
            request_id,
            warnings,
        }
