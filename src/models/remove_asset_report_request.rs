...
pub struct RemoveAssetReportRequest {
...
impl RemoveAssetReportRequest {
    pub fn new(client_id: String, secret: String, asset_report_token: String) -> RemoveAssetReportRequest {
