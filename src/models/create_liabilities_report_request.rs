...
pub struct CreateLiabilitiesReportRequest {
...
impl CreateLiabilitiesReportRequest {
    pub fn new(client_id: String, secret: String, access_tokens: Vec<String>, days_requested: i32) -> CreateLiabilitiesReportRequest {
        CreateLiabilitiesReportRequest {
            client_id,
            secret,
            access_tokens,
            days_requested,
