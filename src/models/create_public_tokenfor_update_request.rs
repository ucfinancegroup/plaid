...
pub struct CreatePublicTokenforUpdateRequest {
...
impl CreatePublicTokenforUpdateRequest {
    pub fn new(client_id: String, secret: String, access_token: String) -> CreatePublicTokenforUpdateRequest {
