...
pub struct RetrieveLiabilitiesReportRequest {
...
impl RetrieveLiabilitiesReportRequest {
    pub fn new(client_id: String, secret: String, liabilities_report_token: String) -> RetrieveLiabilitiesReportRequest {
