...
pub struct SearchInstitutionbyIdExample {
...
impl SearchInstitutionbyIdExample {
    pub fn new(institution: crate::models::Institution, request_id: String) -> SearchInstitutionbyIdExample {
