...
pub struct AutomatedDepositWebhookRequest {
...
impl AutomatedDepositWebhookRequest {
    pub fn new(client_id: String, secret: String, access_token: String, account_id: String, verification_status: String) -> AutomatedDepositWebhookRequest {
        AutomatedDepositWebhookRequest {
            client_id,
            secret,
            access_token,
            account_id,
