...
pub struct RetrieveCategoriesResponse {
...
impl RetrieveCategoriesResponse {
    pub fn new(categories: Vec<crate::models::Category>, request_id: String) -> RetrieveCategoriesResponse {
