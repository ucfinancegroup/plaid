...
pub struct RetrieveBalanceResponse {
...
impl RetrieveBalanceResponse {
    pub fn new(accounts: Vec<crate::models::Account>, item: crate::models::Item, request_id: String) -> RetrieveBalanceResponse {
