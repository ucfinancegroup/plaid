...
pub struct UpdateAnItemsWebhookResponse {
    #[serde(rename = "item")]
...
impl UpdateAnItemsWebhookResponse {
    pub fn new(item: crate::models::Item, request_id: String) -> UpdateAnItemsWebhookResponse {
