...
pub struct RetrieveLiabilitiesRequest {
...
impl RetrieveLiabilitiesRequest {
    pub fn new(client_id: String, secret: String, access_token: String) -> RetrieveLiabilitiesRequest {
