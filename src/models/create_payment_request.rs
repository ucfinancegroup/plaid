...
pub struct CreatePaymentRequest {
    ...
    #[serde(rename = "amount")]
    pub amount: crate::models::Amount,
}

impl CreatePaymentRequest {
    pub fn new(client_id: String, secret: String, recipient_id: String, reference: String, amount: crate::models::Amount) -> CreatePaymentRequest {
