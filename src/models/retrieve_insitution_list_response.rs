...
pub struct RetrieveInsitutionListResponse {
...
impl RetrieveInsitutionListResponse {
    pub fn new(institutions: Vec<crate::models::Institution>, request_id: String, total: i32) -> RetrieveInsitutionListResponse {
