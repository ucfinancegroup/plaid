...
pub struct ListPaymentRecipientsResponse {
    #[serde(rename = "recipients")]
    pub recipients: Vec<crate::models::PaymentRecipient>,
    #[serde(rename = "request_id")]
    pub request_id: String,
}

impl ListPaymentRecipientsResponse {
    pub fn new(recipients: Vec<crate::models::PaymentRecipient>, request_id: String) -> ListPaymentRecipientsResponse {
