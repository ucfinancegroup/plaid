...
pub struct CreatePaymentRecipientResponse {
...
impl CreatePaymentRecipientResponse {
    pub fn new(recipient_id: String, request_id: String) -> CreatePaymentRecipientResponse {
        CreatePaymentRecipientResponse {
            recipient_id,
            request_id,
        }
    }
