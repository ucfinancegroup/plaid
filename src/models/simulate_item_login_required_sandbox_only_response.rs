...
pub struct SimulateItemLoginRequiredSandboxOnlyResponse {
...
impl SimulateItemLoginRequiredSandboxOnlyResponse {
    pub fn new(request_id: String, reset_login: bool) -> SimulateItemLoginRequiredSandboxOnlyResponse {
