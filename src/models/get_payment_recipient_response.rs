...
pub struct GetPaymentRecipientResponse {
...
impl GetPaymentRecipientResponse {
    pub fn new(recipient_id: String, name: String, address: crate::models::Address3, iban: String, request_id: String) -> GetPaymentRecipientResponse {
