...
pub struct RetrieveAnItemsAccountsExample {
...
impl RetrieveAnItemsAccountsExample {
    pub fn new(accounts: Vec<crate::models::Account>, item: crate::models::Item, request_id: String) -> RetrieveAnItemsAccountsExample {
